    ...
    -- Plugin hotkeys
        ...
        -- File-explorer(nvim-tree)
            ...
            -- Space + Enter = Open selected file in Nvim in new terminal window
                ...
                keymap('n',             '<leader><CR>',     ':lua save_dir_under_nvim_tree_cursor(); open_file_in_nvim_in_new_terminal()<CR>:NvimTreeToggle<CR>',   hotkey_default_opts)

            -- Space + t + Enter = Open selected folder in new terminal window
                require("config.scripts.open-nvim-tree-file-in-new-terminal.functions")
                keymap('n',             '<leader>t<CR>',    ':lua save_dir_under_nvim_tree_cursor(); open_folder_in_new_terminal()<CR>:NvimTreeToggle<CR>',         hotkey_default_opts)
        ...
        -- LSP - autocomplete and other launguage-specific features (nvim-lspconfig)
            ...
            -- Linter
                -- Space + ls      = Cycle severity (Info/Warning/Error)
                    require("config.scripts.lsp-cycle-linter-severity.function")
                    keymap('n',         '<leader>ls',       ':lua lsp_cycle_linter_severity()<CR>',                                                                 hotkey_default_opts)
