...
function open_folder_in_new_terminal()
	...
	os.execute("alacritty -o 'terminal.shell.program=\"" .. folderPath .. "/openAlacritty.sh" .. "\"'" .. " &")
end

function open_file_in_nvim_in_new_terminal()
	-- Execute alacritty using an option to open 'openNvimInNewTerminal.sh'
	os.execute("alacritty -o 'terminal.shell.program=\"" .. folderPath .. "/openAlacrittyNvim.sh" .. "\"'" .. " &")
end
